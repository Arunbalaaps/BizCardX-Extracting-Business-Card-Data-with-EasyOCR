...
icon = Image.open("id-card.png")
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR | By Arun Bala",
                   page_icon= icon,
                   layout= "wide",
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        saved_img = os.getcwd()+ "\\" + "uploaded_cards"+ "\\"+ uploaded_card.name
        result = reader.readtext(saved_img,detail = 0,paragraph=False,gpu=False)
